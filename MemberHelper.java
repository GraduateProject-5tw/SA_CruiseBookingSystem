...
public class MemberHelper {
    ...
    public JSONObject create(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `missa`.`members`(`name`, `email`, `password`, `phone`,  `login_date`, `credit_card`)"
                    + " VALUES( ?, ?, ?, ?, ?, ?)";
    ...
    public JSONObject update(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `missa`.`members` SET `name` = ? ,`password` = ? ,`phone` = ? ,`credit_card` = ?  WHERE `email` = ?";
            /** 取得所需之參數 */
            String name = m.getName();
            String email = m.getEmail();
            String password = m.getPassword();

...
public class Product {
     ...
     * @param describe 產品敘述
     */
	public Product(int id, String name, String stop_port, double price, String image, String describe) {
		this.id = id;
		this.name = name;
		this.stop_port = stop_port;
		this.price = price;
		this.image = image;
